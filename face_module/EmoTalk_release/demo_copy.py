...
def main():
    ...
    parser.add_argument("--wav_path", type=str, default="/home/yai/team2/junwan/VITS/input.wav", help='path of the test data')
    ...
    render_video(args)
    # model = load_STF(args)
    # speech_array, sampling_rate = librosa.load(args.wav_path, sr=16000)
    # test(args, model, speech_array, file_name='input')
    # render_video(args)
