...
def LDT(path):
    ...
    BM = BMManager.BMMng('/home/work/YAI-Summer/junwan/GPT2FACE/VITS/BlendShapeMaker/data/blendshapes/', path)
    BM.LoadBS()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--ldt_path', default="/home/work/YAI-Summer/junwan/GPT2FACE/VITS/BlendShapeMaker/Inputs/Horse.ply", type=str, help='path for 3D Avatar')
